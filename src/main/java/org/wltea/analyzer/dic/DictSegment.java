...
class DictSegment implements Comparable<DictSegment>{
	 ...
	 * @return Hit
	 */
	org.wltea.analyzer.dic.Hit match(char[] charArray){
	 ...
	 * @return Hit 
	 */
	org.wltea.analyzer.dic.Hit match(char[] charArray , int begin , int length){
	 ...
	 * @return Hit 
	 */
	org.wltea.analyzer.dic.Hit match(char[] charArray , int begin , int length , org.wltea.analyzer.dic.Hit searchHit){
		
		if(searchHit == null){
			//如果hit为空，新建
			searchHit= new org.wltea.analyzer.dic.Hit();
			//设置hit的其实文本位置
