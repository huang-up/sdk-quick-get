...
class QuickSortSet {
	 ...
	 * @param lexeme
	 */
	boolean addLexeme(org.wltea.analyzer.core.Lexeme lexeme){
	 ...
	 * @return
	 */
	org.wltea.analyzer.core.Lexeme peekFirst(){
		if(this.head != null){
	 ...
	 * @return Lexeme
	 */
	org.wltea.analyzer.core.Lexeme pollFirst(){
		if(this.size == 1){
			org.wltea.analyzer.core.Lexeme first = this.head.lexeme;
			this.head = null;
			this.tail = null;
			this.size--;
			return first;
	 ...
	 * @return
	 */
	org.wltea.analyzer.core.Lexeme peekLast(){
		if(this.tail != null){
	 ...
	 * @return Lexeme
	 */
	org.wltea.analyzer.core.Lexeme pollLast(){
		if(this.size == 1){
			org.wltea.analyzer.core.Lexeme last = this.head.lexeme;
			this.head = null;
			this.tail = null;
			this.size--;
			return last;
			...
			org.wltea.analyzer.core.Lexeme last = this.tail.lexeme;
	...
	class Cell implements Comparable<Cell>{
		private Cell prev;
		private Cell next;
		private org.wltea.analyzer.core.Lexeme lexeme;
		
		Cell(org.wltea.analyzer.core.Lexeme lexeme){
			if(lexeme == null){
		...
		public org.wltea.analyzer.core.Lexeme getLexeme(){
			return this.lexeme;
		}
	}
}
